pub(super) mod get_uniswap_v3_pool {
    pub const PATH: &str = "/crypto/uniswap/v3/pool";
    ...
    pub struct Params {
        chain:   BlockChain,
        fee:     Uint24,
        token_0: String,  // Address or Symbol
        token_1: String,  // Address or Symbol
    }
    ...
    pub async fn handler(_c: Trip, Query(p): Query<Params>) -> ResponseResult<Reply> {
        ...
        let pool_contract_address = factory_contract.get_pool(&token_0, &token_1, p.fee).await?;
